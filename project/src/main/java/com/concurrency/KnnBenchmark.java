...
public class KnnBenchmark {
    ...
    public void setup() throws Exception {
        // Carrega o treino e o teste direto
        this.train = loadData.load("anac_train.csv", 500000); 
        this.testSet = loadData.load("anac_test.csv", 100);
    ...
    public void benchmarkKnnLoteCompleto(Blackhole bh) {
        for (Point p : testSet) {
            // Chama o regressor
            Double resultado = Knn.regressor(train, p.getFeatures(), k);
            bh.consume(resultado);
        }
    }
